...
if (1):
    nclusters = 12
    energies_filename = 'new_traj/tram/final_400K/energy_model_1.txt'
...
#    model_protectionfactor = loadtxt('H/pf_state%d.txt'%i)
...
#    model_chemicalshift_H = loadtxt('new_traj/H/cs_%d.txt'%i)
#    model_chemicalshift_N = loadtxt('new_traj/N/cs_%d.txt'%i)
#    model_chemicalshift_Ca = loadtxt('new_traj/Ca/cs_%d.txt'%i)
...
#    s = Structure('new_traj/pdb/state%d.pdb'%i, args.lam*energies[i],  expdata_filename_cs_H=expdata_filename_cs_H, expdata_filename_cs_N=expdata_filename_cs_N,expdata_filename_cs_Ca=expdata_filename_cs_Ca, expdata_filename_PF=expdata_filename_PF, use_log_normal_distances=False, dloggamma=np.log(1.01), gamma_min=0.2, gamma_max=5.0, dalpha=0.1, alpha_min=0.1, alpha_max=5.0)	#GYH
#    s = Structure('../HDX/states/test/state%d.pdb'%i, args.lam*energies[i],  expdata_filename_PF=expdata_filename_PF, use_log_normal_distances=False, dloggamma=np.log(1.01), gamma_min=0.2, gamma_max=5.0, dalpha=0.1, alpha_min=-10.0, alpha_max=10.0)        #GYH

    s = Structure('new_traj/pdb/T5/state%d.pdb'%i, args.lam*energies[i],  expdata_filename_PF=expdata_filename_PF, use_log_normal_distances=False, dloggamma=np.log(1.01), gamma_min=0.2, gamma_max=5.0, dalpha=0.05, alpha_min=3.0, alpha_max=5.0)        #GYH
