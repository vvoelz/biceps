...
#    model_protectionfactor = loadtxt('../HDX/PF/test/pf_state%d.txt'%i)
    model_protectionfactor = loadtxt('new_traj/PF/backup/pf_state%d.txt'%i) 
    model_chemicalshift_H = loadtxt('new_traj/H/backup/cs_%d.txt'%i)
    model_chemicalshift_N = loadtxt('new_traj/N/backup/cs_%d.txt'%i)
    model_chemicalshift_Ca = loadtxt('new_traj/Ca/backup/cs_%d.txt'%i)
