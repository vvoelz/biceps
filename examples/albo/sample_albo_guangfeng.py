...
expdata_filename = 'albocycline_Guangfeng.yaml'
...
for i in range(100):
    ...
    # QM + exp               --> lam = 1.0
    ensemble.append( Structure('pdbs_guangfeng/%d.pdb'%i, args.lam*energies[i], expdata_filename, use_log_normal_distances=False) )
