...
def biceps_restraint_line_noe(restraint_index, i, j, topology, distance):
...
def biceps_restraint_line_header_noe():
...
class RestraintFile_noe(object):
    ...
    def __init__(self, filename=None):
        ...
        self.header = biceps_restraint_line_header_noe()
        self.comments = []
        self.lines  = []
    ...
    def add_line_noe(self, restraint_index, i, j, topology, distance):
        """Add a line to the BICePs file."""

        self.lines.append(biceps_restraint_line_noe(restraint_index, i, j, topology, distance))
