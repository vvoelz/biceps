...
class PosteriorSampler(object):
    ...
    def __init__(self, ensemble, dlogsigma_noe=np.log(1.01), sigma_noe_min=0.05, sigma_noe_max=120.0,
				 ...
				 use_reference_prior_noe=True, use_reference_prior_H=True, use_reference_prior_Ha=False, use_reference_prior_N=True, use_reference_prior_Ca=True, use_reference_prior_PF=True,  sample_ambiguous_distances=True, use_gaussian_reference_prior_noe=True, use_gaussian_reference_prior_H=True, use_gaussian_reference_prior_Ha=False, use_gaussian_reference_prior_N=True, use_gaussian_reference_prior_Ca=True, use_gaussian_reference_prior_PF=True):	#GYH
	...
	# pick initial values for sigma_cs_H (std of experimental uncertainty in chemical shift)   #GYH
        ...
        self.traj = PosteriorSamplingTrajectory(self.ensembles[0], self.allowed_sigma_noe, self.allowed_sigma_J, self.allowed_sigma_cs_H, self.allowed_sigma_cs_Ha, self.allowed_sigma_cs_N, self.allowed_sigma_cs_Ca, self.allowed_sigma_PF, self.allowed_gamma, self.allowed_alpha)
...
#	    print 'global_ref_sigma_H', global_ref_sigma_H
            for j in range(nchemicalshift_H):
...
#	    print 'global_ref_sigma_Ha', global_ref_sigma_Ha
#	    sys.exit()
            for j in range(nchemicalshift_Ha):
...
class PosteriorSamplingTrajectory(object):
    ...
    def __init__(self, ensemble, allowed_sigma_noe, allowed_sigma_J, allowed_sigma_cs_H, allowed_sigma_cs_Ha, allowed_sigma_cs_N, allowed_sigma_cs_Ca, allowed_sigma_PF, allowed_gamma, allowed_alpha):	#GYH
