...
expdata_filename_noe = 'trploop2a.noe' 
#expdata_filename_J = ''
...
#    s = Structure('Gens/Gens%d.pdb'%i, args.lam*energies[i], expdata_filename_noe, expdata_filename_J, expdata_filename_cs, use_log_normal_distances=False, dloggamma=np.log(1.01), gamma_min=0.2, gamma_max=5.0)
    s = Structure('Gens/Gens%d.pdb'%i, args.lam*energies[i], expdata_filename_noe=expdata_filename_noe, expdata_filename_cs_H=expdata_filename_cs_H, expdata_filename_cs_Ha=expdata_filename_cs_Ha,  use_log_normal_distances=False, dloggamma=np.log(1.01), gamma_min=0.2, gamma_max=5.0)
...
if (0):
  ...
  sampler = PosteriorSampler(ensemble, dlogsigma_noe=np.log(1.01), sigma_noe_min=0.2, sigma_noe_max=10.0,
                                 ...
                                 dlogsigma_cs_H=np.log(1.02), sigma_cs_H_min=0.01, sigma_cs_H_max=20.0,
                                 dlogsigma_cs_Ha=np.log(1.02), sigma_cs_Ha_min=0.01, sigma_cs_Ha_max=20.0,
				 dloggamma=np.log(1.01), gamma_min=0.2, gamma_max=5.0,
                                 use_reference_prior_noe=not(args.noref), use_reference_prior_H=True, use_reference_prior_Ha=True, use_reference_prior_N=False, use_reference_prior_Ca=False, use_reference_prior_PF=False, sample_ambiguous_distances=False)
