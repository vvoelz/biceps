...
path='cs_HA/cs/Ha/*txt'
states=50
indices='cs_HA/cs_indices_Ha.txt'
exp_data='cs_HA/chemical_shift_Ha.txt'
top='cs_HA/8690.pdb'
data_dir=path
dataFiles = 'test_cs_Ha'
out_dir=dataFiles

p=Preparation('cs_Ha',states=states,indices=indices,exp_data=exp_data,top=top,data_dir=data_dir)
...
outdir = 'results_ref_normal_cs_Ha'
...
for j in lambda_values:
	...
	if verbose:
            print data[i]
        s = Restraint_cs_Ha('8690.pdb',lam,
