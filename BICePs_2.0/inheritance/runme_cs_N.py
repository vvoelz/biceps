...
path='cs_N/cs/N/*txt'
states=50
indices='cs_N/cs_indices_N.txt'
exp_data='cs_N/chemical_shift_N.txt'
top='cs_N/8690.pdb'
data_dir=path
dataFiles = 'test_cs_N'
out_dir=dataFiles
...
#p=Preparation('cs_N',states=states,indices=indices,exp_data=exp_data,top=top,data_dir=data_dir)
...
outdir = 'results_ref_normal_cs_N'
