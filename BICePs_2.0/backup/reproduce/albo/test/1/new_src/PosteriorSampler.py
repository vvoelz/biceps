...
#        RAND = 1. - 1./(len(self.ensemble[0]) + 1.)
        ...
        for step in range(nsteps):
            ...
            index0=parameter_indices[0][0]
            nuisance_para0 = self.nuisance_para[0][new_state][0] 
...
#            self.new_para_index = np.random.randint(
#                    len(self.parameter_indices[new_rest_index]) )
...
#            if np.random.random() < RAND:
                ...
                # Randomly generate new restraint index for the next step
#                new_rest_index = np.random.randint(len(self.ensemble[0]))
#                new_para_index = np.random.randint(
#                    len(parameter_indices[new_rest_index]) )
#                index = parameter_indices[new_rest_index][new_para_index]
#                nuisance_para = self.nuisance_para[new_rest_index][new_state][new_para_index]
...
#                parameter_indices[new_rest_index][new_para_index] = index
            ...
            if np.random.random()< 0.49:
                index0 += (np.random.randint(3)-1)
                index0 = index0%(len(nuisance_para0))
                parameters[0][0] = nuisance_para0[index0]
                parameter_indices[0][0] = index0
