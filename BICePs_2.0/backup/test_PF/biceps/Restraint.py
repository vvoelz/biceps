...
class Restraint_pf(Restraint):
    ...
    def prep_observable(self,lam, free_energy, filename,precomputed_pf = False, Ncs=None, Nhs=None,verbose=False):
        ...
        self._parameter_indices = ['sigma_index','beta_c_index','beta_0_index','xcs_index','xhs_index','bs_index']
        ...
        if precomputed_pf:
            for entry in self.data:
                restraint_index, i, exp, model  = entry[0], entry[1], entry[3], entry[4]
            ...
            for entry in self.data:
                restraint_index, i, exp, model  = entry[0], entry[1], entry[3]
