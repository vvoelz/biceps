...
class restraint_cs_H(object):
    def __init__(self):
        ...
        self.neglog_exp_ref_H = None
	self.neglog_gau_ref_H = None
        self.sum_neglog_exp_ref_H = 0.0    #GYH
        self.sum_neglog_gau_ref_H = 0.0      #GYH
    ...
    def compute_neglog_exp_ref_H(self):              #GYH
        ...
        for j in range(self.ncs_H):
            ...
            print "self.sum_neglog_exp_ref_H", self.sum_neglog_exp_ref_H
