...
class Restraint(inheri):
	...
	use_log_normal_noe	Not sure what's this...
	...
	self.conf = mdtraj.load_pdb(PDB_filename)
        ...
        # Flag to use log-normal noe errors log(d/d0)
...
#	r_noe = restraint_noe(gamma_min=self.gamma_min,gamma_max=self.gamma_max,dloggamma=self.dloggamma,use_log_normal_noe=self.use_log_normal_noe)
...
#        self.sse_noe = r_noe.sse_noe
#        self.Ndof_noe = r_noe.Ndof_noe
#        self.noe_restraints = r_noe.noe_restraints
#        self.noe_equivalency_groups = r_noe.noe_equivalency_groups
#        self.nnoe = r_noe.nnoe
