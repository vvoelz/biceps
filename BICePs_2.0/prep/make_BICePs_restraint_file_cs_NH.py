...
Ind = np.loadtxt('cs_indices_NH.txt')
...
2	0.2795903
"""
restraint_data = np.loadtxt('chemical_shift_NH.txt')
...
for j in range(50):
	model_data=np.loadtxt('cs/H/cs_%d.txt'%j)
...
#print r
	...
	r.write('test_cs_H/ligand1_%d.cs_H'%j)
