...
class Restraint_pf(Restraint):
    ...
    def prep_observable(self,lam, free_energy, filename,precomputed_pf = False, Ncs=None, Nhs=None,verbose=False, beta_c_min=0.05,beta_c_max=0.25,dbeta_c=0.01,beta_h_min=0.0,beta_h_max=5.2,dbeta_h=0.2,beta_0_min=-10.0,beta_0_max=0.0,dbeta_0=0.2,xcs_min=5.0,xcs_max=8.5,dxcs=0.5,xhs_min=2.0,xhs_max=2.7,dxhs=0.1,bs_min=15.0,bs_max=16.0,dbs=1.0):
