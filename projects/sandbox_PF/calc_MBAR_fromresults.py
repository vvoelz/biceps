...
for n in range(nsnaps):
  ...
  for k in range(K):
    for l in range(K):
      ...
      if (1):
          state, sigma_noe_index, sigma_J_index, sigma_cs_H_index, sigma_cs_Ha_index, sigma_cs_N_index, sigma_cs_Ca_index, sigma_PF_index, gamma_index, beta_c_index, beta_h_index, beta_0_index, xcs_index, xhs_index, bs_index = traj[k]['trajectory'][n][3:]	#GYH 03/2017
#          state, sigma_noe_index, sigma_J_index, sigma_cs_H_index, sigma_cs_Ha_index, sigma_cs_N_index, sigma_cs_Ca_index, sigma_PF_index, gamma_index = traj[k]['trajectory'][n][3:]

          print 'state, sigma_noe_index, sigma_J_index, sigma_cs_H_index, sigma_cs_Ha_index, sigma_cs_N_index, sigma_cs_Ca_index, sigma_PF_index, gamma_index, beta_c_index', 'beta_h_index', 'beta_0_index', 'xcs_index', 'xhs_index', 'bs_index', state, sigma_noe_index, sigma_J_index, sigma_cs_H_index, sigma_cs_Ha_index, sigma_cs_N_index, sigma_cs_Ca_index, sigma_PF_index, gamma_index, beta_c_index, beta_h_index, beta_0_index, xcs_index, xhs_index, bs_index	#GYH 03/2017
#          print 'state, sigma_noe_index, sigma_J_index, sigma_cs_H_index, sigma_cs_Ha_index, sigma_cs_N_index, sigma_cs_Ca_index, sigma_PF_index, gamma_index, alpha_index', state, sigma_noe_index, sigma_J_index, sigma_cs_H_index, sigma_cs_Ha_index, sigma_cs_N_index, sigma_cs_Ca_index, sigma_PF_index, gamma_index  #GYH
