...
sim=np.loadtxt("NOE/rminus6_whole_state0.txt")
y1=sim*10.
#y1= sim**(-1./6.)
x=np.loadtxt("junk.txt")
y2=np.loadtxt("NOE/average_whole_state179.txt")
...
plt.title('Comparison of exp vs sim (state0)')
...
plt.annotate('rms=%s'%d,xy=(5,2),color='black',fontsize=18)
plt.annotate('rms=%s'%j,xy=(5,3),color='red',fontsize=18)
