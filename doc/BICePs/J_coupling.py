...
def compute_J3_HN_HA(traj, model="Bax2007"):
    ...
    .. `[4] Habeck, M.; Rieping, W.; Nilges, M.
       Bayesian Estimation of Karplus Parameters and Torsion Angles from
       Three-Bond Scalar Couplings Constants.
       J. Magn. Reson. 2005, 177 (1), 160–165.`

    .. `[5] Vuister, G. W.; Bax, A.
       Quantitative J Correlation: A New Approach for
