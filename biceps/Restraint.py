...
class Restraint(object):
    ...
    Initialize all necessary functions and compute quantities including SSE, Ndof, reference potentials.
    """
    ...
    def __init__(self, PDB_filename, ref, use_global_ref_sigma=True):
        ...
        use_global_ref_sigma    Necessary if use Gaussian reference potentials.
        """
